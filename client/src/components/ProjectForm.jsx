              ...
              {data.map((project,index)=>(
                <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                  ...
                  <div className='grid md:grid-cols-2 gap-3'>
                    ...
                    <textarea rows={4} value={project.description || ""} onChange={(e)=>updateProject(index,"description",e.target.value)} className='w-full md:col-span-2 px-3 py-2 text-sm rounded-lg resize-none' placeholder='Project Description...'/>
                  </div>
                </div>
              ))}
          </div>
